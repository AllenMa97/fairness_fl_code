...
def ProxProbability(device,
    ...
    for iter_t in range(communication_round_I):
        ...
        results = parallel_executor.run_clients(idxs_users, _train_single_client_proxprobability, device, global_model, param_dict, training_dataloaders, algorithm_epoch_T, use_amp, scaler, basic_path, iter_t, communication_round_I, num_clients_K, criterion)
