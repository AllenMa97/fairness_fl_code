...
def GroupConstrain_DISTILLDATA(param_dict, model, client_i_dataloader, device,
    ...
    # if 80 > client_batch_num > 50:
    #     N_of_max_synthetic_batch = client_batch_num
    # if client_batch_num > 80:
    #     N_of_max_synthetic_batch = 80
...
def AggregatedProgressive(device,
            global_model,
    ...
    save_path = os.path.join(save_dir, f"global_AggregatedProgressive.pt")
