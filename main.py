...
def Argparse():
    ...
    parser.add_argument("-system_data_count", default=4000, type=int,
                        help="Limit the total number of training samples used in the experiment. "
                             ...
                             "Used for quick testing/smoke tests. Default: 4000. "
                             "限制实验使用的训练样本总数。设为正整数N时，仅使用前N条样本，用于快速测试/冒烟测试。默认4000")
